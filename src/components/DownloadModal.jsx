...
export default function DownloadModal({ photos, onClose }) {
  ...
  useEffect(() => {
    ...
    const loadAndDraw = async () => {
      ...
      ctx.fillText('PELLICULA — 35mm — ISO 400', STRIP_W / 2, STRIP_H - 6)
    }
        ...
        <div className="p-4 flex flex-col gap-4">
          ...
          <div>
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = '#c8862a'; e.currentTarget.style.color = '#0d0b09' }}
              onMouseLeave={e => { e.currentTarget.style.background = '#2a1f14'; e.currentTarget.style.color = '#c8862a' }}
            >
              <Download size={16} />
              Download Full Strip
            </button>
